...
from TransX.TransAll_v3 import *
...
def main():
    ...
    if solver_params['phase'] == 'train':
        ...
        if not solver_params.has_key('save_fld'):
            solver_params['save_fld'] = 'models/TransAll_v3_{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(
        ...
        if not solver_params.has_key('summary_fld'):
            solver_params['summary_fld']='graphs/TransAll_v3_{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(
                                        trainset_params['data_path'].split('/')[-1], 
                                        trainset_params['sample'],
                                        net_params['embed_size'],
                                        net_params['margin'],
        ...
        if not testset_params.has_key('save_fld') or testset_params['save_fld'] == '':
            testset_params['save_fld'] = 'models/TransAll_v3_{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(
                                        trainset_params['data_path'].split('/')[-1], 
                                        trainset_params['sample'],
                                        net_params['embed_size'],
                                        net_params['margin'],
